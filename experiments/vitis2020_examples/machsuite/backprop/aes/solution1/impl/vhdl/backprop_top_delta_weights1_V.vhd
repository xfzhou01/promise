...
entity backprop_top_delta_weights1_V_ram is 
    generic(
            DWIDTH     : integer := 32; 
            AWIDTH     : integer := 10; 
...
architecture rtl of backprop_top_delta_weights1_V_ram is 
...
entity backprop_top_delta_weights1_V is
    generic (
...
architecture arch of backprop_top_delta_weights1_V is
    component backprop_top_delta_weights1_V_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    backprop_top_delta_weights1_V_ram_U :  component backprop_top_delta_weights1_V_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
