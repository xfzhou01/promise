...
entity aes_top_aes_expandEncKey_sbox_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of aes_top_aes_expandEncKey_sbox_rom is 
...
entity aes_top_aes_expandEncKey_sbox is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of aes_top_aes_expandEncKey_sbox is
    component aes_top_aes_expandEncKey_sbox_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes_top_aes_expandEncKey_sbox_rom_U :  component aes_top_aes_expandEncKey_sbox_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
